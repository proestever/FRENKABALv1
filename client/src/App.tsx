...
function Header() {
  return (
    <header className="backdrop-blur-sm bg-card/80 shadow-md border-b border-border/50 sticky top-0 z-30">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex space-x-4 items-center">
          <button className="hidden md:flex px-4 py-2 text-sm glass-card rounded-md hover:bg-secondary/70 transition">
...
function Footer() {
  return (
    <footer className="backdrop-blur-sm bg-card/60 border-t border-border/40 py-6 mt-12 glass-highlight">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-border/30 mt-6 pt-6 text-sm text-muted-foreground text-center">
