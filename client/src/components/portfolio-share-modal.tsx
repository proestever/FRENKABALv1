...
export function PortfolioShareModal({ 
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl w-[90vw] bg-gradient-to-b from-black via-gray-950 to-black border-gray-800 text-white p-0 overflow-hidden [&>button]:text-gray-400 [&>button]:hover:text-white [&>button]:absolute [&>button]:right-4 [&>button]:top-4 [&>button]:z-20">
