      ...
      <div className="block md:hidden">
        <div className="space-y-2">
          {sortedTokens.map((token) => {
            ...
            return (
              <div key={token.address} className="p-4 border border-border rounded-lg hover:bg-secondary/30 transition-colors">
                  ...
                  <div className="flex items-center flex-grow">
                    ...
                    <div className="min-w-0 flex-grow">
                      <div className="flex items-center gap-1">
                        <span className="text-sm font-medium text-foreground truncate max-w-[160px]" title={token.name}>{token.name}</span>
                        {token.verified && (
                  ...
                  <div className="flex flex-col items-end">
                    ...
                    <div className="flex gap-2 items-center">
                      ...
                      <button 
                        ...
                        className={`p-1 rounded-full ${isHidden ? 'text-muted-foreground' : 'text-purple-400'}`}
