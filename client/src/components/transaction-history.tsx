...
export function TransactionHistory({ walletAddress, onClose }: TransactionHistoryProps) {
  ...
  const { isLoading, isError, data: initialData, refetch } = useQuery({
    queryKey: ['transactions', walletAddress, Date.now()], // Add timestamp to ensure fresh data on every render
    queryFn: async () => {
  ...
  const { data: walletData } = useQuery({
    queryKey: ['wallet', walletAddress, Date.now()], // Add timestamp to ensure fresh data on every render
    queryFn: async () => {
      try {
